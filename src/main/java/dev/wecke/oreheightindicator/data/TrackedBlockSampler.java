...
/**
 * Builds a sparse observed height profile for selected blocks that do not have
 * a readable ore-style worldgen profile. It samples nearby loaded client chunks
 * and never requests or generates chunks.
 */
public final class TrackedBlockSampler {
    ...
    private static Map<String, Profile> sample(
